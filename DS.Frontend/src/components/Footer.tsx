      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/index" className="flex items-center space-x-2 mb-4">
            ...
            <p className="text-gray-400 max-w-xs">
              Secure, decentralized file storage for the modern world. Built on
        ...
        <div className="mt-12 pt-6 border-t border-white/10 text-center text-gray-500">
          <p>© 2023 BlockStore. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
