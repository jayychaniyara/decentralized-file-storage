        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
              <span className="text-gradient glow-effect">Decentralized</span> File Storage
              <br />
              <span className="text-white">For the Future</span>
            </h1>
            
            <p className="text-lg text-gray-300 max-w-xl">
              Secure, tamper-proof, and lightning-fast decentralized storage powered
              by blockchain technology. Your files, your control, anywhere in the world.
            </p>
            
            <div className="flex flex-wrap gap-4">
              <Link to="/signup">
                <Button size="lg" className="bg-gradient-to-r from-neon-blue to-neon-purple hover:shadow-lg hover:shadow-neon-purple/30 transition-all duration-300 animate-pulse-glow">
                  Get Started
                </Button>
              </Link>
