      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Three simple steps to secure your files forever on our decentralized network.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative">
          ...
          <div className="hidden md:block absolute top-1/2 left-1/3 w-1/3 h-0.5 bg-gradient-to-r from-neon-blue to-neon-purple"></div>
          <div className="hidden md:block absolute top-1/2 right-1/3 w-1/3 h-0.5 bg-gradient-to-r from-neon-purple to-neon-cyan"></div>
        </div>
      </div>
    </section>
  );
